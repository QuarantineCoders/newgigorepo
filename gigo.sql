...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2020 at 04:37 PM
...
INSERT INTO `customer` (`cus_id`, `Name`, `House_no`, `street_id`) VALUES
(1, 'Patrick', '70h', '02S'),
(2, 'Thanis', '71h', '03S'),
(3, 'Mohan', '72h', '02S'),
(4, 'Jeya kumar', '73h', '20S'),
(5, 'Jeyakumar', '74h', '04S'),
(6, 'Siva', '75h', '04S'),
(7, 'Vijay', '76h', '06S'),
(8, 'Kamal', '77h', '09S'),
(9, 'Joy', '78h', '13S'),
(30, 'Vadivel Abiseth', '79h', '08S'),
(31, 'Lenna Josh', '80h', '05S'),
(32, 'Kumara Perera', '81h', '10S'),
(35, 'Bala Kumar', '82h', '16S');
...
('abiseth@gmail.com', '456789', 30),
('lenna@gmail.com', '345678', 31),
('kumara@gmail.com', 'k23456', 32),
('Bala@gmail.com', 'b6789', 35);
...
--
ALTER TABLE `customer`
  MODIFY `cus_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `details`
  ADD CONSTRAINT `details_ibfk_1` FOREIGN KEY (`id`) REFERENCES `customer` (`cus_id`);

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_id` FOREIGN KEY (`id`) REFERENCES `customer` (`cus_id`);
COMMIT;
